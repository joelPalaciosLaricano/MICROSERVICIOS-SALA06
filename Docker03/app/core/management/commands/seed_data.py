...
class Command(BaseCommand):
    ...
    def _create_categories(self, count):
        ...
        category_names = [
            ...
            'Negocios', 'Opinión', 'Arte', 'Historia', 'Estilo de vida',
            'Música', 'Cocina', 'Familia', 'Mascotas', 'Tecnología educativa',
            'Medio ambiente', 'Fotografía', 'Gaming', 'Autos', 'Inmobiliaria',
            'Jardinería', 'Moda', 'Ciencia ficción', 'Salud mental', 'Bienestar'
        ]
    ...
    def _create_posts(self, count, authors, categories):
        ...
        for i in range(count):
            ...
            try:
                ...
                # Si ya existe un slug/registro único, lo saltamos y seguimos
                self.stdout.write(self.style.WARNING(f'  - Skipping post due to IntegrityError: {e}'))